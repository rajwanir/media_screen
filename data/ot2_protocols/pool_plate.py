...
taget_plates = ['P1','P2','P3','P4','P5','P6','P7','P8','P9']
...
#     plates['P11'] = protocol.load_labware('corning_96_wellplate_360ul_flat', 4)
    ...
    pool_rack = {}
    pool_rack['P1'] = stock_rack.wells_by_name()['A1']
    pool_rack['P2'] = stock_rack.wells_by_name()['A2']
    pool_rack['P3'] = stock_rack.wells_by_name()['A3']
    pool_rack['P4'] = stock_rack.wells_by_name()['A4']
    pool_rack['P5'] = stock_rack.wells_by_name()['A5']
    pool_rack['P6'] = stock_rack.wells_by_name()['A6']
    pool_rack['P7'] = stock_rack.wells_by_name()['B1']
    pool_rack['P8'] = stock_rack.wells_by_name()['B2']
    pool_rack['P9'] = stock_rack.wells_by_name()['B3']
  #  pool_rack['P10'] = stock_rack.wells_by_name()['A5']
  #  pool_rack['P11'] = stock_rack.wells_by_name()['A5']
    
    for p in taget_plates:
        #add water
        p20.consolidate(volume = 1,
                         source = [plates[p].wells_by_name()[well_name] for well_name in all_wells],
                         dest = pool_rack[p])
